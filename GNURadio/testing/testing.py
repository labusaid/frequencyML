...
class testing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "testing for frequencyML", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("testing for frequencyML")
        ...
        # Blocks
        ##################################################
        self._variable_qtgui_range_0_range = Range(10, 10000, 1, 50, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/labusaid/Documents/School/Fall2021/CS Project/frequencyML/GNURadio/test_recording', False)
